<x-slot name="header_content">
    <h1>{{__('Edit Mahasiswa Berprestasi')}}</h1>
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="shadow overflow-hidden sm:rounded-md">
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <div x-data="{ isUploading: false, progress: 5 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false; progress = 5" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                                            ...
                                            @if ($undangan)
                                            <a href="{{asset("/storage/files/".$undangan)}}" target="_blank"><span class="fa fa-file-pdf text-6xl mb-2"></span></a>
                                            @endif
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <div x-data="{ isUploading: false, progress: 5 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false; progress = 5" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                                            ...
                                            @if ($surat_tugas)
                                                <a href="{{asset("/storage/files/".$surat_tugas)}}" target="_blank"><span class="fa fa-file-pdf text-6xl mb-2"></span></a>
                                            @endif
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <div x-data="{ isUploading: false, progress: 5 }" x-on:livewire-upload-start="isUploading = true" x-on:livewire-upload-finish="isUploading = false; progress = 5" x-on:livewire-upload-error="isUploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress">
                                            ...
                                            @if ($bukti)
                                            <a href="{{asset("/storage/files/".$bukti)}}" target="_blank"><span class="fa fa-file-pdf text-6xl mb-2"></span></a>
                                            @endif
                            ...
                            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                <button wire:click.prevent="update" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Update
                                </button>
                                <a href="{{route('list-mahasiswa-prestasi')}}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Batal
                                </a>
                            </div>
                    </div>
