        ...
        <div class="w-full lg:w-2/3 bg-white p-5 rounded-lg lg:rounded-l-none border-gray-800">
            ...
            <div>
                <div class="mt-3 relative">
                    ...
                    <input wire:model="nama" placeholder="   Masukan nama lengkap anda" type="text" name="nama" :value="old('nama')" id="nama" class="@error('nama') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
            ...
            <div>
                <div class="mt-3 relative">
                    ...
                    <input wire:model="no_hp" placeholder="   Masukan nomor handphone anda" type="text" name="no_hp" :value="old('no_hp')" id="no_hp" class="@error('no_hp') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
            ...
            <div class="w-full sm:w-1/2 py-1">
                <div class="relative">
                    ...
                    <input wire:model="angkatan" placeholder="   Masukan tahun angkatan anda" type="text" name="angkatan" :value="old('angkatan')" id="angkatan" class="@error('angkatan') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
                </div>
                @error('angkatan')
                <div>
                    <span class="text-sm text-red-600">{{ $message }}</span>
            ...
            <div class="w-full py-1 flex space-x-2">
                ...
                <div class="relative flex-1 sm:w1/2 w-full">
                    ...
                    <input wire:model="tahun_wisuda" placeholder="Masukan tahun wisuda anda" type="text" name="tahun_wisuda" :value="old('tahun_wisuda')" id="tahun_wisuda" class="@error('tahun_wisuda') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
                    @error('tahun_wisuda')
                    <div class="mt-1">
                        <span class="absolute text-sm text-red-600">{{ $message }}</span>
                    </div>
            ...
            <div>
                <div class="mt-3 relative">
                    ...
                    <input wire:model="no_ijazah" placeholder="Masukan Nomor Ijazah" type="text" name="no_ijazah" id="no_ijazah" class="@error('no_ijazah') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
            ...
            <div class="mb-4 w-full sm:w-full py-1 ">
                ...
                <div class="mt-2 px-3 flex @error('status') border-red-600 @enderror">
                    <label class="inline-flex items-center">
                        ...
                        <input id="bekerja" wire:model.prevent="status" type="radio" class="form-radio" name="status" value="1">
                        <span class="ml-2">Sudah Bekerja</span>
                    </label>
                    <label class="inline-flex items-center ml-6">
                        <input wire:model.prevent="status" id="belum_bekerja" type="radio" class="form-radio" name="status" value="0">
                        <span class="ml-2">Belum Bekerja</span>
                    </label>
                    <label class="inline-flex items-center ml-6">
                        <input wire:model.prevent="status" id="lanjut_kuliah" type="radio" class="form-radio" name="status" value="2">
            ...
            @if ($status == 1)
                <div class="w-full mt-2 py-1">
                    <div class="relative">
                        ...
                        <input wire:model="tempat_bekerja_pertama" placeholder="  Kosongkan bila belum bekerja" type="text" name="tempat_bekerja_pertama" :value="old('tempat_bekerja_pertama')" id="tempat_bekerja_pertama" class="@error('tempat_bekerja_pertama') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
                ...
                <div class="w-full mt-2 pb-1">
                    <div class="relative">
                        ...
                        <input wire:model="tempat_bekerja_sekarang" placeholder="  Kosongkan bila belum bekerja" type="text" name="tempat_bekerja_sekarang" :value="old('tempat_bekerja_sekarang')" id="tempat_bekerja_sekarang" class="@error('tempat_bekerja_sekarang') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
                ...
                <div class="w-full mt-2 py-1">
                    <div class="relative">
                        ...
                        <input wire:model="posisi_bagian" placeholder="  Kosongkan bila belum bekerja" type="text" name="posisi_bagian" :value="old('posisi_bagian')" id="posisi_bagian" class="@error('posisi_bagian') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
                ...
                <div class="py-1">
                    <div class="mt-3 relative">
                        ...
                        <textarea wire:model="alamat_kantor" placeholder="Masukan alamat kantor anda" rows="6" name="alamat_kantor" :value="old('alamat_kantor')" id="alamat_kantor" class="@error('alamat_kantor') border-red-600 @enderror px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></textarea>
                ...
                <div class="w-full mt-2 py-1">
                    <div class="relative">
                        ...
                        <input wire:model="website_kantor" placeholder="  Kosongkan bila belum bekerja" type="url" name="website_kantor" :value="old('website_kantor')" id="website_kantor" class="@error('website_kantor') border-red-600 @enderror h-12 px-2 w-full border-2 rounded focus:outline-none focus:border-purple-600"></input>
