...
class MahasiswaPrestasiExport implements FromQuery, WithHeadings, WithMapping
{
    use Exportable;

    public function query()
    {
        return MahasiswaPrestasi::query()->with('jurusan', 'tingkat_prestasi', 'jenis_prestasi', 'kegiatan');
    }
    ...
    public function map($mahasiswa_prestasi): array
    {
        return [
            ...
            $mahasiswa_prestasi->jurusan->kode,
